...
public class AsteroidSpawner : MonoBehaviour
{
    ...
    public GameObject waveSpawner = null;
    ...
    void Awake()
    {
        ...
        wave = 1;
        AsteroidsCount = 1;
        waveSpawner = GameObject.FindGameObjectWithTag("Canvas").transform.Find("WaveAnouncer").gameObject;
